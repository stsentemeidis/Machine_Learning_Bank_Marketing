  ...
  assign(paste0('results', suffix),
         as.data.frame(
           rbind(
             ...
             'Sensitivity' = Sensitivity(y_pred = get(paste0('pred_glm', suffix)),positive = '1',
                                         y_true = valid_set[,target]),
             'Precision' = Precision(y_pred = get(paste0('pred_glm', suffix)),positive = '1',
                                     y_true = valid_set[,target]),
             'Recall' = Recall(y_pred = get(paste0('pred_glm', suffix)),positive = '1',
                               y_true = valid_set[,target]),
             'F1 Score' = F1_Score(y_pred = get(paste0('pred_glm', suffix)),positive = '1',
                                   y_true = valid_set[,target]),
