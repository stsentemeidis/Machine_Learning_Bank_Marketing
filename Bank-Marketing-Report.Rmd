...
* Variables related to **campaign interactions** with the customer:  
  ...
  * **`poutcome`**
  This categorical variable indicates the outcome from a previous campaign, whether it was a success or a failure. About `r ` of the customers answered positively to previous campaigns.  
